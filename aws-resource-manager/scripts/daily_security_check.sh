...
# Generate report
python security_group_remediation.py report --output "$REPORT_DIR/security_report_$DATE.json"

# Find critical open security groups
python security_group_remediation.py find --ports "22,3389,1433,3306" --output "$REPORT_DIR/critical_open_sgs_$DATE.json"
