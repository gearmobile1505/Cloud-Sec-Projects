...
python ../automation/security_group_remediation.py report --output "$COMPLIANCE_DIR/compliance_report_$DATE.json"

# Check specific compliance requirements
echo "Checking specific compliance rules..."

# Rule 1: No SSH/RDP from internet
python ../automation/security_group_remediation.py find --ports "22,3389" --output "$COMPLIANCE_DIR/ssh_rdp_violations_$DATE.json"

# Rule 2: No database ports from internet
python ../automation/security_group_remediation.py find --ports "3306,5432,1433,27017,6379" --output "$COMPLIANCE_DIR/database_violations_$DATE.json"

# Rule 3: No management ports from internet
python ../automation/security_group_remediation.py find --ports "8080,9000,8443,5601" --output "$COMPLIANCE_DIR/mgmt_violations_$DATE.json"
